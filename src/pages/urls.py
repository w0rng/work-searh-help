...
from pages.subscription import views as subscription_views
from pages.module import views as modules_views
from pages.analyze import views as analyze_views
...
urlpatterns = [
    ...
    path('login/', views.LoginView.as_view(template_name='auth/templates/auth/login.html'), name='login'),
    path('logout/', views.LogoutView.as_view(template_name='auth/templates/auth/logout.html'), name='logout'),
